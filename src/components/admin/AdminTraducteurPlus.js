...
class AdminTraducteurPlus extends React.Component{
    ...
    componentDidMount() {
        Axios.get('http://localhost/api/admin_traducteur?email='+this.mail).then((res)=>{
    ...
    render() {
        return <div className={"col-xs-12"} style={{paddingBottom:"50px"}}>
                    ...
                    <table className=" col-xs-12 zero_pad" style={{marginTop: "20px"}}>
                        ...
                        {this.state.devis.map((i,itr) => {
                            ...
                            return <tr className={"table_element"} key={itr}>
                                ...
                                <td> <a href={"http://localhost/files/raw_pdf/"+i.id_devis+".pdf"} download={true} target="_blank">  {i.nom_document} </a></td>
                    ...
                    <table className=" col-xs-12 zero_pad" style={{marginTop: "20px"}}>
                        ...
                        {this.state.traductions.map((i,itr) => {
                            ...
                            return <tr className={"table_element"} key={itr}>
                                ...
                                <td> <a href={"http://localhost/files/translated_pdf/"+i.id_devis+".pdf"} download={true} target="_blank">  {i.nom_document} </a></td>
...
export default AdminTraducteurPlus ;